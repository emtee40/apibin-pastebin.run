  ...
  return (
    <div class={classes.about}>
      <p>
        ...
        in a web browser as well as applications running outside of web browser
        (such as Discord bots).
      </p>
      <p>
        If you are looking for a pastebin, please visit our main web site,{" "}
        ...
        and it's much more prone to breaking. And it's not because of APIs
        changing &mdash; those are intended to remain stable, but rather because
        we can change the routes at any time &mdash; this isn't a production
        application.
      </p>
      <p>
        Why does this exist?{" "}
